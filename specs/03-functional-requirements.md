...
| Certificates | Drafted, no open questions | `functional-requirements/13-certificates.md` |
| Administration And Moderation | Drafted, no open questions | `functional-requirements/14-administration-and-moderation.md` |
